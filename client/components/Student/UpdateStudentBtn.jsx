...
const UpdateStudentBtn = ({ student }) => {
  ...
  const { data, refetch } = useGetStudentQuery(student._id);
      ...
      >
        <form onSubmit={onSubmit} className='space-y-4'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3'>
            ...
            <div className='flex flex-col mx-2 '>
              <label htmlFor='updateLevel'>Class</label>
              <select
                name='level'
                id='updateLevel'
                className='bg-gray-300 rounded px-4 py-1'
            ...
            <div className='flex flex-col mx-2 '>
              <label htmlFor='updateSubLevel'>Sub Class</label>
              <select
                name='subLevel'
                id='updateSubLevel'
                className='bg-gray-300 rounded px-4 py-1'
            ...
            <div className='flex flex-col mx-2 '>
              <label htmlFor='sponsorNameUpdate'>Sponsor Name</label>
              <input
                type='text'
                name='sponsorName'
                placeholder='Enter sponsor full name'
                id='sponsorNameUpdate'
                value={sponsorName}
                onChange={handleInputChange}
                className='bg-gray-300 rounded px-4 py-1'
              />
            ...
            <div className='flex flex-col mx-2 '>
              <label htmlFor='sponsorRelationshipUpdate'>
                Relationship With Sponsor
              </label>
              <select
                name='sponsorRelationship'
                id='sponsorRelationshipUpdate'
                onChange={handleInputChange}
                className='bg-gray-300 rounded px-4 py-1'
              >
                <option value=''></option>
            ...
            <div className='flex flex-col mx-2 '>
              <label htmlFor='sponsorPhoneNumberUpdate'>
            ...
            <div className='flex flex-col mx-2 '>
              <label htmlFor='sponsorEmailUpdate'>Sponsor Email Address</label>
              <input
                type='email'
                name='sponsorEmail'
